 ...
 */
public class SnippetWindow extends Stage {
    private final TextArea sourceField;
    private final TextArea logField;

    public SnippetWindow(Stage parent) {
        initOwner(parent);
        // does not have to be modal
        ...
        BorderPane p = new BorderPane(split);
        p.setTop(tb);
        setScene(new Scene(p, 800, 700));
    }
