...
public class RichTestUtil {
     ...
     */
    public static String getText(AbstractStyledTextArea r, SelectionSegment sel) {
        if (sel == null) {
            return null;
        }
     ...
     */
    public static String getText(AbstractStyledTextArea r, TextPos start, TextPos end) {
