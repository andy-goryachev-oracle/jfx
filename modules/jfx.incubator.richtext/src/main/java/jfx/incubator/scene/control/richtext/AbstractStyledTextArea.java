...
/**
 * The base class for rich text controls.
 *
 * @since 27
 * @author Andy Goryachev
 */
public abstract class AbstractStyledTextArea extends Control {
    /**
    ...
    static {
        RichTextAreaHelper.setAccessor(new RichTextAreaHelper.Accessor() {
            @Override
            public boolean getText(AbstractStyledTextArea t, TextPos start, TextPos end, StringBuilder sb, int limit) {
     ...
     */
    public AbstractStyledTextArea(StyledTextModel model) {
     ...
     *
     * @return the insert styles or {@code null}
     * @since 27
     */
    public abstract StyleAttributeMap getInsertStyles();
        ...
        if (displayCaret == null) {
            displayCaret = new StyleableBooleanProperty(Params.DEFAULT_DISPLAY_CARET) {
                ...
                public Object getBean() {
                    return AbstractStyledTextArea.this;
                }
                ...
                @Override
                public CssMetaData<AbstractStyledTextArea, Boolean> getCssMetaData() {
    ...
    private static class StyleableProperties {
        private static final CssMetaData<AbstractStyledTextArea, Duration> CARET_BLINK_PERIOD =
            new CssMetaData<>("-fx-caret-blink-period", DurationConverter.getInstance())
        {
            @Override
            public boolean isSettable(AbstractStyledTextArea t) {
                return t.caretBlinkPeriod == null || !t.caretBlinkPeriod.isBound();
            }

            @Override
            public StyleableProperty<Duration> getStyleableProperty(AbstractStyledTextArea t) {
                return (StyleableProperty<Duration>)t.caretBlinkPeriodProperty();
            }
        };

        private static final CssMetaData<AbstractStyledTextArea, Insets> CONTENT_PADDING =
            new CssMetaData<>("-fx-content-padding", InsetsConverter.getInstance())
        {
            ...
            @Override
            public StyleableProperty<Insets> getStyleableProperty(AbstractStyledTextArea t) {
                return (StyleableProperty<Insets>)t.contentPaddingProperty();
            }
        };

        private static final CssMetaData<AbstractStyledTextArea,Boolean> DISPLAY_CARET =
            new CssMetaData<>("-fx-display-caret", StyleConverter.getBooleanConverter(), Params.DEFAULT_DISPLAY_CARET)
        {
            ...
            @Override
            public StyleableProperty<Boolean> getStyleableProperty(AbstractStyledTextArea t) {
                return (StyleableProperty<Boolean>)t.displayCaretProperty();
            }
        };

        private static final CssMetaData<AbstractStyledTextArea,Boolean> HIGHLIGHT_CURRENT_PARAGRAPH =
        ...
        private static final CssMetaData<AbstractStyledTextArea,Boolean> USE_CONTENT_HEIGHT =
        ...
        private static final CssMetaData<AbstractStyledTextArea,Boolean> USE_CONTENT_WIDTH =
        ...
        private static final CssMetaData<AbstractStyledTextArea,Boolean> WRAP_TEXT =
    ...
    private static StyleHandlerRegistry initStyleHandlerRegistry() {
        ...
        StyleAttributeHandler<AbstractStyledTextArea, Double> spaceHandler = (c, cx, v) -> {
